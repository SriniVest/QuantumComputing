...
public class CameraAdminActivity extends AppCompatActivity {
    ...
    private Camera.PictureCallback mPicture = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            try {
                ...
                Log.d("Size Gambar", String.valueOf(bitmap.getByteCount()));
                fos.close();
                ...
                Intent intent = new Intent(CameraAdminActivity.this, EnrollActivity.class);
    ...
    public static Bitmap rotate(Bitmap bitmap, int degree) {
        int w = bitmap.getWidth() * 480 / bitmap.getWidth();
        int h = bitmap.getHeight() * 640 / bitmap.getHeight();
    ...
    private static File getOutputMediaFile(int type) {
        ...
        String timeStamp = "RicognizeAdmin";
        File mediaFile;
